...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    public ServicioPersistenciaMock() {
        if (vendedores == null) {
            ...
            ofertas.add(new Oferta(1, "Pedro", 245, 10.200));
            ofertas.add(new Oferta(2, "Mariana", 425, 44.200));
            ofertas.add(new Oferta(3, "Daniel", 745, 22.200));
            ofertas.add(new Oferta(4, "Armando", 145, 55.200));
